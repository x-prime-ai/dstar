...
| ----------------------------------------------- | ------------------------------------------------------------ | ----------------------------------------------------------------------- | ------------------------------------------------------- | ----------------------------------------------------- | ----------------------- | --------------------------------- |
| xPrime                                          | local `91c49d5`; `XPRIME_ROOT=… pnpm check:xprime`           | Passed: real UI → xPrime → pending proposal → separate human acceptance | Not claimed: current local Resource work is uncommitted | Not implemented by host                               | Not implemented by host | Eleven tool-complete operations   |
| Official MCP TypeScript client conformance host | `@modelcontextprotocol/client` 2.0.0, linked transport tests | Passed                                                                  | Passed: templates/list/read and audience scope          | Passed: modern `subscriptions/listen` update delivery | Not a UI host           | Tools remain independently usable |
